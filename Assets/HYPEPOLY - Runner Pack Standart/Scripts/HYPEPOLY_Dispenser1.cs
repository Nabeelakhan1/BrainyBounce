...
public class HYPEPOLY_Dispenser : MonoBehaviour
{
    ...
    public void CreateArrow()
    {
       ...
       // currentArrow.GetComponent<CollisionDetector>().sonicPlayer = GameManager.instance.sonicPlayer;
    ...
    public void Shoot()
    {
        ...
        VRSonicSoundManager.instance.PlaySound("Arrow", transform.position);
    }
