...
public class ThrowController : MonoBehaviour
{
    ...
    private void Update()
    {
        //this script is being connected to UIManagerScript using singleton pattern
        //once connected it can access UIManager's function
        //stops spawning the ball when game is paused 
    ...
    {
        totalThrows--;
        //get the postion in 2d
        Vector3 touchPosition = Input.GetTouch(0).position;

        //convert the 2d pos into 3d,  
